...
import type { Application, ApplicationUpdate, Referral, Resume } from '@/types/database.types'
...
import { updateApplication, getReferrals, getResumes } from '@/lib/supabase/queries'
...
export default function EditApplicationDialog({
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const updatedApp = await updateApplication(application.id, data)
      toast({
        title: 'Application updated',
        description: `Successfully updated application to ${data.company_name}`,
      })
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                defaultValue={application.application_source || undefined}
              >
                <SelectTrigger>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Select name="resume_id" defaultValue={application.resume_id || undefined}>
                <SelectTrigger>
            ...
            <div className="space-y-2">
              ...
              <Select name="referral_id" defaultValue={application.referral_id || undefined}>
                <SelectTrigger>
